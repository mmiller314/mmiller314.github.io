...
function DisplayAnswers(props) {
  ...
  for (var i = 0; i < props.answers.incorrect_answers.length; i++) {
    choices.push(_react.default.createElement("button", {
      ...
      dangerouslySetInnerHTML: {
        __html: props.answers.incorrect_answers[i]
      }
    }));
  }
  ...
  choices.push(_react.default.createElement("button", {
    ...
    className: "btn btn-primary btn-block",
    dangerouslySetInnerHTML: {
      __html: props.answers.correct_answer
    }
  }));
...
function Results(props) {
  var message = 'You need some practice';
...
},{"axios":3,"react":38}],2:[function(require,module,exports){
"use strict";
...
var _Trivia = _interopRequireDefault(require("./components/Trivia"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react.default.createElement(_Trivia.default, null), document.getElementById('react-root'));

},{"./components/Trivia":1,"react":38,"react-dom":35}],3:[function(require,module,exports){
...
},{"./cjs/scheduler-tracing.development.js":39,"./cjs/scheduler-tracing.production.min.js":40,"_process":30}]},{},[2]);
